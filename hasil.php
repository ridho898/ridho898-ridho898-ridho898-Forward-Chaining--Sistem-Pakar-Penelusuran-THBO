...
<div class="panel panel-primary">
    <div class="panel-heading">  
        ...
        <h3 class="panel-title"><?php echo $lang_menu_gejalaterpilih;?></h3>
    </div>
    <table class="table-zebra-striping">
    <thead>
        <tr>
            <th>No</th>
            <th><?php echo $lang_menu_gejala;?></th>
        </tr>
    </thead>
    <?php
    $no=1;
...
<div class="panel panel-primary">
    <div class="panel-heading">        
        <h3 class="panel-title"><?php echo $lang_menu_hasilidentifikasi;?></h3>
    </div>
    <table class="table table-bordered table-hover table-striped">
    <thead>
        <tr>
            <th>No</th>
            <th><?php echo $lang_menu_hama;?></th>
            <th><?php echo $lang_menu_kepercayaan;?></th>
        </tr>
    </thead>
    <?php
    $no=1;
    ...
    <div class="panel-body">
        <table class="table table-bordered">
            <tr>
                <td><?php echo $lang_menu_hama;?> </td>
                <td><?=$DIAGNOSA[key($rank)]->nama_diagnosa?></td>
            </tr>
            <tr>
                <td><?php echo $lang_menu_solusi;?></td>
